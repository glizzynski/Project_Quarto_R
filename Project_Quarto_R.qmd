...
![Data source table](Source_Excel.png){fig-align="right" height="300"}
...
**Conclusion:** The map clearly shows two clusters corresponding to areas where the majority of these offences (assaults on minors) occur, indicating where preventive measures in this regard should be intensified.
...
**Conclusion:** For certain crimes there are marked differences in the number of reports depending on area. For instance, “BURGLARY FROM VEHICLE” occurred overwhelmingly in the “Central” area (with more than twice as many reports as in any other area). Other offences show no area-related variation (e.g. “THEFT OF IDENTITY”).
