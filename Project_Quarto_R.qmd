...
#    panel.grid = element_blank()
  ...
  geom_text(data=base_data, aes(x = title, y = -25, label=gsub('(.{1,10})(\\s|$)', '\\1\n', Crm.Cd.Desc)), hjust=c(1,1,0,0,0), colour = "black", alpha=0.8, size=6, fontface="bold", inherit.aes = FALSE)
